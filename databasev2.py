...
##    print (count)
    ...
    db1.create_table(dict(ROW_ID= "int", username= "char", password= "char"))
##    dt=timedelta(milliseconds=1)
##    print(dt.total_seconds())
    db1.insert(dict(ROW_ID = 101, username = 'user1.login@domain.com', password = 'password1'))
    db1.insert(dict(ROW_ID = 102, username = 'user2@domain.com', password = 'password2'))
    ...
    for item in db1.retrieve_rows():
            ...
            db2.insert(dict(ROW_ID = 102, username = 'user2', password = 'password2',applicationname = 'GMAIL', applicationurl = 'https://accounts.google.com/'))
